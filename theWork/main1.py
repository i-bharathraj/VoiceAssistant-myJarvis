# A voice assistant based on Llama3
# Working on Win 11, Trust me!
...
def speak_text(text):
    ...
    try:
        print("Before Loading mp3")
        mixer.music.load(mp3file, "mp3")
        print("After Loading mp3")
        mixer.music.play()
    ...
    while True:     
        ...
        with mic as source:            
            ...
            try: 
                ...
                if sleeping == True:
                    # User must start the conversation with the wake word "Jarvis"
                ...
                # AI is awake         
                    ...
                    if "jarvis" in request:
                        request = request.split("jarvis")[1]                        
